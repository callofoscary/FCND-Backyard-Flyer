...
class BackyardFlyer(Drone):
    ...
    def __init__(self, connection):
        ...
        self.target_position = np.array([0.0, 0.0, 0.5]) #Donde quiero ir 
        self.all_waypoints = [] #guardar los waypoints
    ...
    #Aqui es donde declaro los estados por los que va a pasar el dron en caso de estar en una mision
